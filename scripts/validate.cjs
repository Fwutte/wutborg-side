...
checkModule("js/game-art-3d.js", "shared 3d materials");
checkModule("js/battle-gates-art.js", "battlefield art");
checkModule("js/mario-art.js", "Mario illustration");
checkHtmlScript("scripts/game-expansion.browser-test.html", "game graphics browser QA");
...
checkModule("js/battle-gates.js", "borgstorm game");
checkModule("js/borgstorm/core.mjs", "borgstorm v3 simulation");
checkModule("js/borgstorm/scene.mjs", "borgstorm v3 graphics");
checkModule("js/borgstorm/audio.mjs", "borgstorm v3 sound");
checkModule("js/borgstorm/game.mjs", "borgstorm v3 controller");
